...
#define mruby_UI_owns(mrb, ptr) ((mruby_to_native_ref*)ptr)->belongs_to_ruby
#define mruby_UI_unbox(boxed) ((void *)((mruby_to_native_ref *)DATA_PTR(boxed))->obj)
...
mruby_to_native_ref *
mruby_UI_managed_ref_create(void *obj)
{
   mruby_to_native_ref* ref = (mruby_to_native_ref*)calloc(1, sizeof(mruby_to_native_ref));
